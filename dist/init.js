                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        //下载模板 选择模板
                        //通过配置文件，获取模板信息
                        loading = (0, _ora2.default)('初始化项目中...');
                        ...
                        (0, _get.downloadLocal)(projectName, projectType).then(function () {
                          ...
                          var packageJson = isNotMulMaster ? projectName + '/package.json' : projectName + '/master/package.json';
                          if (_fs2.default.existsSync(packageJson)) {
                            ...
                            console.log(_logSymbols2.default.success, _chalk2.default.green(isNotMulMaster ? 'npm install' : 'npm run cinit'));
